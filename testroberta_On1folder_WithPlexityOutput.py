...
def main():
    ...
    gpt2_model_path = "~/.cache/huggingface/hub/models--gpt2/snapshots/607a30d783dfa663caf39e06633721c8d4cfcd7e/"
    gpt2_model_path = gpt2_model_path.replace("~", "/Users/max-imac")
    gpt2_model = GPT2LMHeadModel.from_pretrained(gpt2_model_path, local_files_only=True).to(device)
    gpt2_tokenizer = GPT2TokenizerFast.from_pretrained(gpt2_model_path, local_files_only=True)
    gpt2_model.eval()
